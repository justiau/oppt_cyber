...
namespace oppt
{
class CyberTransitionExecutionPlugin: public TransitionPlugin
{
public:
    CyberTransitionExecutionPlugin():
        TransitionPlugin() {
    }

    virtual ~CyberTransitionExecutionPlugin() = default;
...
OPPT_REGISTER_TRANSITION_PLUGIN(CyberTransitionExecutionPlugin)
