...
namespace oppt
{
class CyberDTransitionPlugin: public TransitionPlugin
{
public:
    CyberDTransitionPlugin():
        TransitionPlugin() {
    }

    virtual ~CyberDTransitionPlugin() = default;
...
OPPT_REGISTER_TRANSITION_PLUGIN(CyberDTransitionPlugin)
