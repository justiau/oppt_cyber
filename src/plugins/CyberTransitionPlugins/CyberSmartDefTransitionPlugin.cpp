...
namespace oppt
{
class CyberSmartDefTransitionPlugin: public TransitionPlugin
{
public:
    CyberSmartDefTransitionPlugin():
        TransitionPlugin() {
    }

    virtual ~CyberSmartDefTransitionPlugin() = default;
...
OPPT_REGISTER_TRANSITION_PLUGIN(CyberSmartDefTransitionPlugin)
