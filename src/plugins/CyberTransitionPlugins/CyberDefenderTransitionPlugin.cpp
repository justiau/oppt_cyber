...
namespace oppt
{
class CyberDefenderTransitionPlugin: public TransitionPlugin
{
public:
    CyberDefenderTransitionPlugin():
        TransitionPlugin() {
    }

    virtual ~CyberDefenderTransitionPlugin() = default;
...
OPPT_REGISTER_TRANSITION_PLUGIN(CyberDefenderTransitionPlugin)
